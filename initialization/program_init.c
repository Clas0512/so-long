...
static void images_player_init(t_program_data *data)
{
    ...
    data->image_addr->player_attr->img_0 = mlx_xpm_file_to_image(data->mlx->mlx_ptr, "textures/p-0.xpm", &(data->texture_px_size), &(data->texture_px_size));
    data->image_addr->player_attr->img_1 = mlx_xpm_file_to_image(data->mlx->mlx_ptr, "textures/p-1.xpm", &(data->texture_px_size), &(data->texture_px_size));
    data->image_addr->player_attr->img_2 = mlx_xpm_file_to_image(data->mlx->mlx_ptr, "textures/p-2.xpm", &(data->texture_px_size), &(data->texture_px_size));
    data->image_addr->player_attr->img_3 = mlx_xpm_file_to_image(data->mlx->mlx_ptr, "textures/p-3.xpm", &(data->texture_px_size), &(data->texture_px_size));
    data->image_addr->player_attr->img_4 = mlx_xpm_file_to_image(data->mlx->mlx_ptr, "textures/p-4.xpm", &(data->texture_px_size), &(data->texture_px_size));
    data->image_addr->player_attr->img_5 = mlx_xpm_file_to_image(data->mlx->mlx_ptr, "textures/p-5.xpm", &(data->texture_px_size), &(data->texture_px_size));
    data->image_addr->player_attr->img_6 = mlx_xpm_file_to_image(data->mlx->mlx_ptr, "textures/p-6.xpm", &(data->texture_px_size), &(data->texture_px_size));
}
